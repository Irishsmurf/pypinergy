...
class UsageEntry:
    ...
    # Performance optimization: __slots__ reduces instance memory overhead by ~75%
    # in large time-series list payloads (e.g. 11 months of daily data).
...
class LevelPayDailyValue:
    ...
    # Performance optimization: __slots__ reduces memory overhead for arrays
    # of half-hourly usage intervals.
