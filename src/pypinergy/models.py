...
class LoginResponse:
    ...
    def _from_dict(cls, d: dict) -> "LoginResponse":
        ...
        return cls(
            ...
            # Performance optimization: removing redundant bool() casts on boolean
            # defaults and using the walrus operator to conditionally cast numerics
            # only when present avoids unnecessary type coercion overhead.
