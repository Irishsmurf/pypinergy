...
class LoginResponse:
    ...
    def _from_dict(cls, d: dict) -> "LoginResponse":
        ...
        return cls(
            ...
            # Performance optimization: Use boolean `or {}` instead of mutable literal defaults
            # like `get(key, {})` to avoid instantiating new objects on every evaluation.
            # Using `or ()` handles missing and None values safely and optimally as `()` is a singleton.
